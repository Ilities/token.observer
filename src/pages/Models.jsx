            ...
            <button
              ...
              style={{
                ...
                background:
                  activeTab === tab.value
                    ? "var(--academia-accent)"
                    : "var(--academia-background-alt)",
                color: activeTab === tab.value ? "#000" : "var(--academia-foreground)",
                border:
                  activeTab === tab.value
                ...
                <thead>
                  <tr>
                    ...
                    {BENCHMARKS.map((bench) => (
                      ...
                      >
                        {bench.name} {sortBy === bench.key ? (sortOrder === "asc" ? "↑" : "↓") : ""}
                      </th>
                    ))}
                  </tr>
                </thead>
