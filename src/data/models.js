...
export const MODELS = [
  // FAST TIER - Small models for consumer hardware
  {
    ...
    apiProviders: [
      ...
      { name: "Groq", input: 0.055, output: 0.22 },
      { name: "Hyperbolic", input: 0.048, output: 0.19 },
      { name: "Fireworks", input: 0.065, output: 0.26 },
      { name: "Together AI", input: 0.07, output: 0.28 },
      { name: "Lepton AI", input: 0.06, output: 0.24 },
      { name: "SambaNova", input: 0.055, output: 0.22 },
      { name: "Novita", input: 0.058, output: 0.23 },
      { name: "Replicate", input: 0.075, output: 0.3 },
      { name: "FriendliAI", input: 0.062, output: 0.25 },
      { name: "SiliconFlow", input: 0.052, output: 0.21 },
      { name: "Anyscale", input: 0.08, output: 0.32 },
      { name: "Cerebras", input: 0.09, output: 0.36 },
    ],
    purchaseOptions: [
      {
  ...
  },
  {
    ...
    apiProviders: [
      ...
      { name: "DeepInfra", input: 0.18, output: 1.44 },
      { name: "Groq", input: 0.17, output: 1.36 },
      { name: "Hyperbolic", input: 0.155, output: 1.24 },
      { name: "Fireworks", input: 0.185, output: 1.48 },
      { name: "Together AI", input: 0.19, output: 1.52 },
      { name: "Lepton AI", input: 0.175, output: 1.4 },
      { name: "SambaNova", input: 0.165, output: 1.32 },
      { name: "Novita", input: 0.17, output: 1.36 },
      { name: "Replicate", input: 0.2, output: 1.6 },
      { name: "FriendliAI", input: 0.18, output: 1.44 },
      { name: "SiliconFlow", input: 0.16, output: 1.28 },
      { name: "Anyscale", input: 0.21, output: 1.68 },
      { name: "Cerebras", input: 0.22, output: 1.76 },
    ],
    purchaseOptions: [
      {
        name: "1× RTX 4090 (24GB)",
  ...
  },
  {
    ...
    apiProviders: [
      ...
      { name: "DeepInfra", input: 0.15, output: 0.6 },
      { name: "Groq", input: 0.145, output: 0.58 },
      { name: "Hyperbolic", input: 0.13, output: 0.52 },
      { name: "Together AI", input: 0.17, output: 0.68 },
      { name: "Lepton AI", input: 0.155, output: 0.62 },
      { name: "SambaNova", input: 0.145, output: 0.58 },
      { name: "Novita", input: 0.15, output: 0.6 },
      { name: "Replicate", input: 0.19, output: 0.76 },
      { name: "FriendliAI", input: 0.16, output: 0.64 },
      { name: "SiliconFlow", input: 0.135, output: 0.54 },
      { name: "Anyscale", input: 0.2, output: 0.8 },
      { name: "Cerebras", input: 0.21, output: 0.84 },
    ],
    purchaseOptions: [
      {
        name: "1× RTX 4090 (24GB)",
  ...
  },
  {
    ...
    apiProviders: [
      ...
      { name: "DeepInfra", input: 0.05, output: 0.2 },
      { name: "Groq", input: 0.045, output: 0.18 },
      { name: "Hyperbolic", input: 0.038, output: 0.15 },
      { name: "Fireworks", input: 0.055, output: 0.22 },
      { name: "Together AI", input: 0.058, output: 0.23 },
      { name: "Lepton AI", input: 0.05, output: 0.2 },
      { name: "SambaNova", input: 0.045, output: 0.18 },
      { name: "Novita", input: 0.048, output: 0.19 },
      { name: "Replicate", input: 0.065, output: 0.26 },
      { name: "FriendliAI", input: 0.052, output: 0.21 },
      { name: "SiliconFlow", input: 0.042, output: 0.17 },
      { name: "Anyscale", input: 0.07, output: 0.28 },
      { name: "Cerebras", input: 0.08, output: 0.32 },
    ],
    purchaseOptions: [
      {
  ...
  // MID TIER - Mid-size models for single datacenter GPU
  {
    ...
    apiProviders: [
      ...
      { name: "DeepInfra", input: 0.24, output: 1.92 },
      { name: "Groq", input: 0.22, output: 1.76 },
      { name: "Hyperbolic", input: 0.185, output: 1.48 },
      { name: "Fireworks", input: 0.25, output: 2.0 },
      { name: "Together AI", input: 0.27, output: 2.16 },
      { name: "Lepton AI", input: 0.24, output: 1.92 },
      { name: "SambaNova", input: 0.21, output: 1.68 },
      { name: "Replicate", input: 0.28, output: 2.24 },
      { name: "FriendliAI", input: 0.25, output: 2.0 },
      { name: "SiliconFlow", input: 0.2, output: 1.6 },
      { name: "Anyscale", input: 0.3, output: 2.4 },
      { name: "Cerebras", input: 0.32, output: 2.56 },
    ],
    purchaseOptions: [
      {
  ...
  },
  {
    ...
    apiProviders: [
      ...
      { name: "DeepInfra", input: 0.23, output: 0.92 },
      { name: "Groq", input: 0.22, output: 0.88 },
      { name: "Hyperbolic", input: 0.19, output: 0.76 },
      { name: "Together AI", input: 0.27, output: 1.08 },
      { name: "Lepton AI", input: 0.24, output: 0.96 },
      { name: "SambaNova", input: 0.22, output: 0.88 },
      { name: "Novita", input: 0.23, output: 0.92 },
      { name: "Replicate", input: 0.28, output: 1.12 },
      { name: "FriendliAI", input: 0.25, output: 1.0 },
      { name: "SiliconFlow", input: 0.21, output: 0.84 },
      { name: "Anyscale", input: 0.3, output: 1.2 },
      { name: "Cerebras", input: 0.32, output: 1.28 },
    ],
    purchaseOptions: [
      {
        name: "4× H100 80GB",
  ...
  },
  {
    ...
    apiProviders: [
      ...
      { name: "OpenRouter", input: 0.18, output: 0.72 },
      { name: "DeepInfra", input: 0.16, output: 0.64 },
      { name: "Groq", input: 0.15, output: 0.6 },
      { name: "Hyperbolic", input: 0.13, output: 0.52 },
      { name: "Fireworks", input: 0.17, output: 0.68 },
      { name: "Together AI", input: 0.18, output: 0.72 },
      { name: "Lepton AI", input: 0.16, output: 0.64 },
      { name: "SambaNova", input: 0.15, output: 0.6 },
      { name: "Novita", input: 0.16, output: 0.64 },
      { name: "Replicate", input: 0.19, output: 0.76 },
      { name: "FriendliAI", input: 0.17, output: 0.68 },
      { name: "SiliconFlow", input: 0.14, output: 0.56 },
      { name: "Anyscale", input: 0.2, output: 0.8 },
      { name: "Cerebras", input: 0.21, output: 0.84 },
    ],
    purchaseOptions: [
  ...
  // TOP TIER - Large models requiring multiple GPUs
  {
    ...
    apiProviders: [
      ...
      { name: "DeepInfra", input: 0.28, output: 1.12 },
      { name: "Groq", input: 0.26, output: 1.04 },
      { name: "Hyperbolic", input: 0.22, output: 0.88 },
      { name: "Fireworks", input: 0.29, output: 1.16 },
      { name: "Together AI", input: 0.3, output: 1.2 },
      { name: "Lepton AI", input: 0.28, output: 1.12 },
      { name: "SambaNova", input: 0.24, output: 0.96 },
      { name: "Novita", input: 0.27, output: 1.08 },
      {
        name: "SambaNova",
        input: null,
        output: null,
      ...
      { name: "Replicate", input: 0.32, output: 1.28 },
      { name: "Anyscale", input: 0.35, output: 1.4 },
      { name: "Cerebras", input: 0.38, output: 1.52 },
    ],
    purchaseOptions: [
      {
  ...
  },
  {
    ...
    apiProviders: [
      ...
      { name: "MiniMax Official", input: 0.3, output: 1.2 },
      { name: "DeepInfra", input: 0.35, output: 1.4 },
      { name: "Groq", input: 0.32, output: 1.28 },
      { name: "Hyperbolic", input: 0.28, output: 1.12 },
      { name: "Fireworks", input: 0.36, output: 1.44 },
      { name: "Together AI", input: 0.37, output: 1.48 },
      { name: "Lepton AI", input: 0.35, output: 1.4 },
      { name: "SambaNova", input: 0.31, output: 1.24 },
      { name: "Novita", input: 0.34, output: 1.36 },
      { name: "Replicate", input: 0.38, output: 1.52 },
      { name: "FriendliAI", input: 0.36, output: 1.44 },
      { name: "SiliconFlow", input: 0.29, output: 1.16 },
      { name: "Anyscale", input: 0.4, output: 1.6 },
      { name: "Cerebras", input: 0.42, output: 1.68 },
    ],
    purchaseOptions: [],
    rentalOptions: [],
  },
  {
    ...
    apiProviders: [
      ...
      { name: "DeepInfra", input: 0.17, output: 0.68 },
      { name: "Groq", input: 0.16, output: 0.64 },
      { name: "Hyperbolic", input: 0.13, output: 0.52 },
      { name: "Lepton AI", input: 0.17, output: 0.68 },
      { name: "SambaNova", input: 0.15, output: 0.6 },
      { name: "Novita", input: 0.16, output: 0.64 },
      { name: "Replicate", input: 0.19, output: 0.76 },
      { name: "FriendliAI", input: 0.18, output: 0.72 },
      { name: "SiliconFlow", input: 0.14, output: 0.56 },
      { name: "Anyscale", input: 0.21, output: 0.84 },
      { name: "Cerebras", input: 0.22, output: 0.88 },
    ],
    purchaseOptions: [
      {
        name: "8× H100 80GB",
  ...
  },
  {
    ...
    apiProviders: [
      ...
      { name: "DeepInfra", input: 0.18, output: 0.72 },
      { name: "Groq", input: 0.17, output: 0.68 },
      { name: "Hyperbolic", input: 0.15, output: 0.6 },
      { name: "Fireworks", input: 0.19, output: 0.76 },
      { name: "Together AI", input: 0.21, output: 0.84 },
      { name: "Lepton AI", input: 0.18, output: 0.72 },
      { name: "SambaNova", input: 0.16, output: 0.64 },
      { name: "Novita", input: 0.17, output: 0.68 },
      { name: "Replicate", input: 0.2, output: 0.8 },
      { name: "FriendliAI", input: 0.19, output: 0.76 },
      { name: "SiliconFlow", input: 0.15, output: 0.6 },
      { name: "Anyscale", input: 0.22, output: 0.88 },
      { name: "Cerebras", input: 0.24, output: 0.96 },
    ],
    purchaseOptions: [
      {
        name: "8× H100 80GB",
  ...
  },
  {
    ...
    apiProviders: [
      ...
      { name: "DeepInfra", input: 0.14, output: 0.56 },
      { name: "Groq", input: 0.13, output: 0.52 },
      { name: "Hyperbolic", input: 0.11, output: 0.44 },
      { name: "Fireworks", input: 0.15, output: 0.6 },
      { name: "Together AI", input: 0.17, output: 0.68 },
      { name: "Lepton AI", input: 0.14, output: 0.56 },
      { name: "SambaNova", input: 0.12, output: 0.48 },
      { name: "Novita", input: 0.13, output: 0.52 },
      { name: "Replicate", input: 0.17, output: 0.68 },
      { name: "FriendliAI", input: 0.15, output: 0.6 },
      { name: "SiliconFlow", input: 0.11, output: 0.44 },
      { name: "Anyscale", input: 0.18, output: 0.72 },
      { name: "Cerebras", input: 0.19, output: 0.76 },
    ],
    purchaseOptions: [
      {
        name: "8× H100 80GB",
  ...
  },
  {
    ...
    apiProviders: [
      ...
      { name: "DeepInfra", input: 0.38, output: 1.52 },
      { name: "Groq", input: 0.36, output: 1.44 },
      { name: "Hyperbolic", input: 0.32, output: 1.28 },
      { name: "Together AI", input: 0.43, output: 1.72 },
      { name: "Lepton AI", input: 0.4, output: 1.6 },
      { name: "SambaNova", input: 0.36, output: 1.44 },
      { name: "Novita", input: 0.39, output: 1.56 },
      { name: "Replicate", input: 0.44, output: 1.76 },
      { name: "FriendliAI", input: 0.41, output: 1.64 },
      { name: "SiliconFlow", input: 0.34, output: 1.36 },
      { name: "Anyscale", input: 0.46, output: 1.84 },
      { name: "Cerebras", input: 0.48, output: 1.92 },
    ],
    purchaseOptions: [
      {
        name: "8× H200 141GB",
  ...
  },
  {
    ...
    apiProviders: [
      ...
      { name: "DeepInfra", input: 0.32, output: 1.28 },
      { name: "Groq", input: 0.3, output: 1.2 },
      { name: "Hyperbolic", input: 0.26, output: 1.04 },
      { name: "Fireworks", input: 0.33, output: 1.32 },
      { name: "Together AI", input: 0.36, output: 1.44 },
      { name: "Lepton AI", input: 0.32, output: 1.28 },
      { name: "SambaNova", input: 0.29, output: 1.16 },
      { name: "Novita", input: 0.31, output: 1.24 },
      { name: "Replicate", input: 0.37, output: 1.48 },
      { name: "FriendliAI", input: 0.34, output: 1.36 },
      { name: "SiliconFlow", input: 0.27, output: 1.08 },
      { name: "Anyscale", input: 0.39, output: 1.56 },
      { name: "Cerebras", input: 0.41, output: 1.64 },
    ],
    purchaseOptions: [
      {
        name: "8× H100 80GB",
